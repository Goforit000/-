<template>
    <div>
      ...
      <div class="search-box">
        ...
        <!-- 查看造价标准文件 -->
        <el-button type="primary" @click="viewPDF">查看行业标准</el-button>
      </div>
...
<el-dialog v-model="showEditDialog" width="400px" title="新增/修改标准" >
      <el-form :model="editForm" label-width="120px">
        ...
        <el-form-item v-for="(label, key) in factorLabels" :key="key" class="custom-form-item">
  ...
  export default {
    ...
    viewPDF() {
      // 使用 Vue Router 跳转到 PDF 页面
      this.$router.push({ name: "pdfViewer" });
    },
...
.custom-switch {
  margin-left: 30px; /* 控制开关与左侧文字的距离 */
  /* 调整开关的尺寸 */
  --el-switch-height: 24px;
  --el-switch-width: 50px;
  --el-switch-border-color: #dcdfe6; /* 边框颜色 */
  --el-switch-on-color: #73cf45; /* 打开时的颜色 */
  --el-switch-off-color: #e67272; /* 关闭时的颜色 */
  --el-switch-disabled-border-color: #ebeef5; /* 禁用状态下的边框颜色 */
  --el-switch-disabled-color: #c0c4cc; /* 禁用状态下的背景颜色 */
}
